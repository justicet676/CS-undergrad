...
The project for this class was for the client The Gaming Room, who requested an update to their phone-based game that made it accessible by other devices. I feel whilst working on this project that I improved as the weeks went on, though I feel the highpoint in the design documentation is the Evaluation section. I did think I could have done better on most of the sections, but mostly because I think there is always room for improvement. I found it helpful to develop the design documentation alongside the code because I think it made it easier to understand the exact requests the client was making, since I was already translating it into my own words. It also made it easier to understand how certain design decisions effected the user, and made me more aware of what would need to be changed or implemented to better improve the user experience. Since the user is the end consumer and is the only one who truly decides whether the project is successful, I think that building projects catering to their needs is a good choice. 
